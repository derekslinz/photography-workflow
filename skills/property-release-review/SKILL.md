...
## Intake Sequence (Step 3 of 6)

For new-photo intake, this skill is **step 3 of 6** in the pipeline:
...
6. **reviewed-photo-publish** — catalog entry, sales-platform listing, remove from intake queue
